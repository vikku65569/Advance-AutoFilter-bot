...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        ...
        [
            InlineKeyboardButton('Vɪsɪᴛ WɪsɪᴏɴX.ᴄᴏᴍ', url=f'https://wisionx.com')
        ],
        [
            ...
            if decoded.startswith("file_"):
                ...
                if AUTH_CHANNEL and not await is_subscribed(client, message):
                    ...
                    if REQUEST_TO_JOIN_MODE:
                        ...
                        invite = await client.create_chat_invite_link(int(AUTH_CHANNEL))

                    btn = [[InlineKeyboardButton("Join our channel first 🛡️", url=invite.invite_link)]]
                    # allow “Try Again” to re-use the same deep-link payload
                    btn.append([
                    ...
                    await message.reply(
                        "<b>🔒 Please join our channel before accessing files.</b>",
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        try:
            ...
            if REQUEST_TO_JOIN_MODE == True:
                if TRY_AGAIN_BTN == True:
                    text = "**🕵️ Yᴏᴜ ʜᴀᴠᴇɴ'ᴛ ɪᴏɪɴᴇᴅ ᴍʏ ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ ʏᴇᴛ. Pʟᴇᴀsᴇ ɪᴏɪɴ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ғɪʀsᴛ, ᴀɴᴅ ᴛʜᴇɴ ᴛʀʏ ᴀɢᴀɪɴ**"
                else:
                    await db.set_msg_command(message.from_user.id, com=message.command[1])
                    text = "**🕵️Yᴏᴜ ʜᴀᴠᴇɴ'ᴛ ɪᴏɪɴᴇᴅ ᴍʏ ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ ʏᴇᴛ. Pʟᴇᴀsᴇ ɪᴏɪɴ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ғɪʀsᴛ, ᴀɴᴅ ᴛʜᴇɴ ᴛʀʏ ᴀɢᴀɪɴ**"
            else:
                text = "**🕵️ Yᴏᴜ ʜᴀᴠᴇɴ'ᴛ ɪᴏɪɴᴇᴅ ᴍʏ ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ ʏᴇᴛ. Pʟᴇᴀsᴇ ɪᴏɪɴ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ғɪʀsᴛ, ᴀɴᴅ ᴛʜᴇɴ ᴛʀʏ ᴀɢᴀɪɴ**"
