...
auth_channel = [int(ch) for ch in (environ.get('AUTH_CHANNEL', '-1002065254823 -1001833410588')).split()]  # give your force subscribe channel id here else leave it blank
